...
* @returns {Uint8Array}
*/
export function resize_image_from_uint8array(bytes, nwidth, nheight, quality) {
    try {
...
* @returns {PhotonImage}
*/
export function open_image_from_uint8array(bytes) {
    var ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    var len0 = WASM_VECTOR_LEN;
...
* @returns {Uint8Array}
*/
export function to_jpeg_uint8array(img, quality) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {Uint8Array}
*/
export function decode_image_from_uint8array(bytes) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;

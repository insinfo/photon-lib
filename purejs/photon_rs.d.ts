declare namespace wasm_bindgen {
	...
	* @returns {Uint8Array}
	*/
	export function resize_image_from_uint8array(bytes: Uint8Array, nwidth: number, nheight: number, quality: number): Uint8Array;
	/**
	* open image from a js Uint8Array and convert to rgba8 PhotonImage;
	* @param {Uint8Array} bytes
	* @returns {PhotonImage}
	*/
	export function open_image_from_uint8array(bytes: Uint8Array): PhotonImage;
	/**
	...
	* @returns {Uint8Array}
	*/
	export function to_jpeg_uint8array(img: PhotonImage, quality: number): Uint8Array;
	/**
	...
	* @returns {Uint8Array}
	*/
	export function decode_image_from_uint8array(bytes: Uint8Array): Uint8Array;
	/**
...
declare interface InitOutput {
  ...
  readonly resize_image_from_uint8array: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly open_image_from_uint8array: (a: number, b: number) => number;
  readonly to_jpeg_uint8array: (a: number, b: number, c: number) => void;
  readonly decode_image_from_uint8array: (a: number, b: number, c: number) => void;

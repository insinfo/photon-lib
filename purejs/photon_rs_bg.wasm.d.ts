...
export function resize_image_from_uint8array(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function open_image_from_uint8array(a: number, b: number): number;
export function to_jpeg_uint8array(a: number, b: number, c: number): void;
export function decode_image_from_uint8array(a: number, b: number, c: number): void;
